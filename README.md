...
"Glitched CupCake": {
  ...
  "Nightmare Balloon Boy": {
    ...
    "Purple Guy": {
        ...
        "Offset": 0,
        "Max": 3,
        "Passive": {"Name": "Animatronic Engineer", "Description": "Spawns turrets that have 50 -> 150 DPS each"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
        ...
        "Upgrades": [
            ...
            },
            {
                ...
                "Damage": 600,
                "Cooldown": 1,
                "Turret1": {"Range": 30, "Damage": 5, "Cooldown": 0.1}
            },
            {
                "Price": 1000,
                "Range": 27,
            ...
            },
            {
                ...
                "Cooldown": 1,
                "Turret1": {"Range": 30, "Damage": 10, "Cooldown": 0.1},
                "Turret2": {"Range": 30, "Damage": 10, "Cooldown": 0.1}
            },
            {
                "Price": 1400,
                "Range": 30,
...
"Tuned Mangle": {
   ...
   "Limitless Shadow": {
    ...
    "Bounty Mangle": {
        ...
        "Offset": 0,
        "Max": 3,
        "Passive": {"Name": "Bounty Hunter", "Description": "Generates lots of extra cash after every shot"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Jackpot Freddy": {
        ...
        "Offset": 0,
        "Max": 3,
        "Passive": {"Name": "Gold Rush", "Description": "Generates lots of extra cash after every shot"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
...
"Phone Guy": {
        ...
        "Offset": 0,
        "Max": 3,
        "Passive": {"Name": "Radio Waves", "Description": "Slows all enemies in range by 30%"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
...
"Deadeye Freddy": {
        ...
        "Offset": 0,
        "Max": 3,
        "Passive": {"Name": "Lethal Precision", "Description": "Deal +100% damage to stunned enemies"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
...
"Ennard": {
        ...
        "Max": 2,
        "MaxChain": 10,
        "Passive": {"Name": "Controlled Shock", "Description": "Sends out a controlled shock that bounces between up to 10 nearby units dealing damage and stunning them"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
...
"Endo 05": {
    ...
    "Old Man Consequences": {
        ...
        "Offset": 0,
        "Max": 1,
        "Passive": {"Name": "Hook and Line", "Description": "Reels in an enemy every few seconds, erasing them completely. Deals x75 damage to bosses."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
...
"Pumpkin Balloon Boy": {
    ...
    "Gravelord Foxy": {
        ...
        "Offset": 0.5,
        "Max": 3,
        "Passive": {"Name": "Necromancer", "Description": "Summons spawns every 10 seconds that have health equal to 25 or 40 times this units damage"},
        "NoEnemyAttack": true,
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
        ...
        "Upgrades": [
            {
                ...
                "Range": 25,
                "Damage": 7000,
                "Unit": {"Necro Spawn": 0.75, "Necro Spawn 2": 0.25},
                "Health": 500,
                "Cooldown": 3
            },
            {
...
"Blighted Endo Bonnie": {
        ...
        "Offset": 0,
        "Max": 2,
        "Passive": {"Name": "Blight", "Description": "Slows all enemies in range by 35% and reduces enemy regen by 75%"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Juggernaut Bonnie": {
        ...
        "Offset": 0.4,
        "Max": 2,
        "Passive": {"Name": "Lethality", "Description": "Every few seconds fires a railgun that deals 50x it's damage and stuns"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Nightguard Afton": {
        ...
        "Offset": 0,
        "Max": 3,
        "Passive": {"Name": "FEAR", "Description": "Slows enemies by 40% and deals +50% damage in poison"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
...
"Sharpshooter Puppet": {
    ...
    "Jar of Pickles": {
        ...
        "Offset": -2,
        "Max": 3,
        "Passive": {"Name": "Slow", "Description": "Slows all enemies in range by 50%"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Overseer Foxy": {
        ...
        "Offset": -3.25,
        "Max": 3,
        "Passive": {"Name": "Crushing Pressure", "Description": "All enemies in range are slowed by 40% and targeted enemies are slowed by 65%"},
        "NoEnemyAttack": true,
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
    ...
    "Kronos Endo Freddy": {
        ...
        "Offset": 0,
        "Max": 1,
        "Passive": {"Name": "Eternity Clock", "Description": "Every 30 seconds freezes all enemies on the map for 10 seconds."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Tarnished Fredbear": {
        ...
        "Offset": 0,
        "Max": 3,
        "Passive": {"Name": "Bite of '87", "Description": "Slows enemies by 30%."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Dark Knight Puppet": {
        ...
        "Offset": 0,
        "Max": 2,
        "Passive": {"Name": "Equinox", "Description": "Every 3rd attack deals 300% damage."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
...
"Freddy Frostbear": {
        ...
        "Offset": 0.25,
        "Max": 3,
        "Passive": {"Name": "Icicles", "Description": "Enemies hit by attacks are slowed by 30%."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Dark Frostbear": {
        ...
        "Offset": 0.25,
        "Max": 3,
        "Passive": {"Name": "Icicles", "Description": "Enemies hit by attacks are slowed by 35%."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Frost Queen Ballora": {
        ...
        "Offset": 0.5,
        "Max": 3,
        "Passive": {"Name": "Frigid Ballad", "Description": "Slows all enemies in range by 40%."},
        "NoEnemyAttack": true,
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
    ...
    "Frostbite Freddy": {
        ...
        "Offset": 0.65,
        "Max": 1,
        "Passive": {"Name": "Snowstorm", "Description": "All enemies in range get slowed by 65%."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Old Man Krampus": {
        ...
        "Offset": 0,
        "Max": 1,
        "Passive": {"Name": "Tidings Of Charcoal", "Description": "Every 3 seconds deals splash damage equal to 50x this units damage in poison. All enemies in range are slowed by 50%."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Wet Floor Bot": {
        ...
        "Offset": -1.75,
        "Max": 3,
        "Passive": {"Name": "Cooldown Boost", "Description": "All units in range attack 10% faster"},
        "NoEnemyAttack": true,
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
    ...
    "Stardrop": {
        ...
        "Max": 2,
        "NoEnemyAttack": true,
        "Passive": {"Name": "Starkindred", "Description": "Grants +35% range to all nearby units (+70% shiny). Stardrop deals +75% damage if either Moondrop or Sunshine are on the same team."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Coffee": {
        ...
        "Offset": -0.3,
        "Max": 8,
        "Passive": {"Name": "Coffee", "Description": "Coffee applies 5% wither to all enemies in range (10% Shiny)"},
        "NoEnemyAttack": true,
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
    ...
    "Gilded Knight": {
        ...
        "Offset": 0,
        "Max": 2,
        "Passive": {"Name": "Grand Equionox", "Description": "Every 3rd attack deals 300% damage."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Shadow of Afton": {
     ...
     "Mike Schmidt": {
        "Type": "Moniton + Flash",
        "Image": "rbxassetid://138216540362625",
        "Rarity": "Pixel",
        "PlacePrice": 13500,
        "Offset": 0,
        "Max": 2,
    ...
    "Blighted Foxy": {
        ...
        "Offset": 0.4,
        "Max": 2,
        "Passive": {"Name": "Wither", "Description": "Attacks cause enemies to take +10% more damage from all sources. (+25% if shiny)"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Titan Crusher Freddy": {
        ...
        "Offset": 0,
        "Max": 1,
        "Passive": {"Name": "Giant Slayer", "Description": "Deal +20% damage to large enemies"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
    ...
    "Apollo's Sun": {
        "Type": "Splash + Anti Heal",
        "Image": "rbxassetid://120968472381141",
        "Rarity": "Apex",
        "PlacePrice": 22000,
        "Offset": 0,
        "Max": 1,
         "Passive": {"Name": "Lights Final Toll", "Description": "Enemies struck by Apollo's Flames recieve 50% anti regen."},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
   ...
   "Gaia Chica": {
    ...
    "Glamrock Bonnie": {
        ...
        "Dark Knight Astral Bonnie": {
        "Type": "Aoe + Nuke",
        "Image": "rbxassetid://81219943460216",
        "Rarity": "Apex",
        "PlacePrice": 1250,
        "Max": 8,
        "Offset": 0.3,
        ...
        "Pixel Foxy": {
        "Type": "Aoe + Melee",
        "Image": "rbxassetid://137042959859660",
        "Rarity": "Pixel",
        "PlacePrice": 1250,
        "Max": 8,
        "Offset": 0.3,
     ...
     "Pixel Chica": {
        "Type": "Splash",
        "Image": "rbxassetid://92295905509303",
        "Rarity": "Pixel",
        "PlacePrice": 500,
        "Max": 8,
        "Offset": 0.3,
        ...
        "Pixel Bonnie": {
        "Type": "Single",
        "Image": "rbxassetid://122700727689917",
        "Rarity": "Pixel",
        "PlacePrice": 250,
        "Max": 8,
        "Offset": 0.3,
      ...
      "Barnacle Boy Patrick": {
        "Type": "Aoe",
        "Image": "rbxassetid://100709329430476",
        "Rarity": "Epic",
        "PlacePrice": 200,
        "Max": 8,
        "Offset": 0.3,
       ...
       "Miss Appear": {
        "Type": "Splash",
        "Image": "rbxassetid://86283028589636",
        "Rarity": "Mythic",
        "PlacePrice": 500,
        "Max": 8,
        "Offset": 0.3,
        ...
        "Upgrades": [
         ...
         "Quickster": {
        "Type": "Fast + Full Aoe",
        "Image": "rbxassetid://86988466771868",
        "Rarity": "Secret",
        "PlacePrice": 1500,
        "Max": 8,
        "Offset": 0.3,
        ...
        "Type": "Jumping Jacks + Caseoh",
        "Image": "rbxassetid://88374221236994",
        "Rarity": "Nightmare",
        "PlacePrice": 5500,
        "Max": 8,
        "Offset": 0.3,
      ...
      "Pixel Bloon": {
        "Type": "Ballon + Propeller",
        "Image": "rbxassetid://101974312732129",
        "Rarity": "Secret",
        "PlacePrice": 1,
        "Max": 8,
        "Offset": 0.3,
    ...
    "Apollo's Moon": {
        "Type": "Splash + Passive",
        "Image": "rbxassetid://110480135815933",
        "Rarity": "Apex",
        "PlacePrice": 38000,
        "Offset": 0,
        "Max": 1,
        "Passive": {"Name": "Dark of The Moon", "Description": "Enemies hit by Apollo's Attacks take +10% more damage for 10 seconds. (20% shiny)"},
        "hitboxOffset": {
            "X": 0,
            "Y": 0,
            "Z": 0
...
"Soulmate Puppet": {
        "Type": "Splash + Passive",
        "Image": "rbxassetid://74779386441810",
        "Rarity": "Secret",
        "PlacePrice": 100,
        "Offset": 0,
        "Max": 2,
